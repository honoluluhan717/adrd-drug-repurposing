...
local claim_file_name = "ptb18clms.sas7bdat"
local line_file_name = "ptb18lnits.sas7bdat"
...
import sas using `line_file_name', clear case(upper)
keep `vars_to_keep'
