...
local output_folder "J:\Geriatrics\Litke_CMS\2019\Output\in_progress\new_bynum"  /* Update with location where files from previous step are saved */


* Update the following macro variables to fit your file;
local HOF_file_name = "servdt_adrd_hof_2019.dta" /* Name of the HOF Claim file */
local Carrier_file_name = "servdt_adrd_carrier_2019.dta" /* Name of the HOF Revenue Center file */
